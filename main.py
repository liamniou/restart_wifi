...
def Usage():
    ...
    print(
        "-u {username}, --user {username}, --username {username}: User name or IP.  Default: admin"
    )
    print(
        "-p {password}, --pass {password}, --password {password}: Password.  Default: admin"
    )
...
def CalcAuthKey(session, cNonce):
    ...
    return Hash(
        "{0}:{1}:{2}:JSON:/cgi/json-req".format(ha1, session["requestID"], cNonce),
        session["type"],
    )
                                                ...
                                                OrderedDict(
                                                    [
                                                        ...
                                                        (
                                                            "depth",
                                                            99,
                                                        ),  # default 2, 6 = refresh, 99 = debug
                                                        (
                                                            "write-only-string",
                                                            "_XMO_WRITE_ONLY_",
                                                        ),
                                                        (
                                                            "undefined-write-only-string",
    ...
    actions = [
        OrderedDict(
            [
                ("id", 0),
                ("method", "setValue"),
                ("xpath", "Device/WiFi/SSIDs/SSID[Alias='WL_VIDEO_5G']/Enable"),
        ...
        OrderedDict(
            [
                ("id", 1),
                ("method", "setValue"),
                ("xpath", "Device/WiFi/AccessPoints/AccessPoint[Alias='VID1']/Enable"),
                ("parameters", {"value": state}),
            ]
        ),
    ]
...
log(f"Action: {'ON' if state else 'OFF'}")
